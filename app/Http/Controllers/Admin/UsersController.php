...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'name', 'email', 'email_verified_at', 'username', 'user_number', 'first_name', 'middle_name', 'last_name', 'activated', 'last_login_at', 'last_login_ip'],

            // set columns to searchIn
            ['id', 'name', 'email', 'username', 'user_number', 'first_name', 'middle_name', 'last_name', 'last_login_ip']
        );
    ...
    public function store(StoreUser $request)
    {
        ...
        if ($request->ajax()) {
            return ['redirect' => url('admin/users'), 'message' => trans('strathmore/admin-ui::admin.operation.succeeded')];
        }
