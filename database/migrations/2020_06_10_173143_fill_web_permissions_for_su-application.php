...
class FillWebPermissionsForSuApplication extends Migration
{
    /**
    ...
    /**
     * FillWebPermissionsForSuApplication constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'su-application',
            'su-application.index',
            'su-application.create',
            'su-application.show',
            'su-application.edit',
            'su-application.delete',
            'su-application.bulk-delete',
        ]);
